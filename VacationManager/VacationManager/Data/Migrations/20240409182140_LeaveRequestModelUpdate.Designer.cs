...
namespace VacationManager.Data.Migrations
{
    ...
    [Migration("20240409182140_LeaveRequestModelUpdate")]
    partial class LeaveRequestModelUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VacationManager.Models.RoleModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VacationManager.Models.TeamModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VacationManager.Models.UserModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VacationManager.Models.VacationDaysModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VacationManager.Models.UserModel", b =>
                {
                    b.HasOne("VacationManager.Models.RoleModel", null)
                        .WithMany("Users")
                        .HasForeignKey("RoleModelId");

                    b.HasOne("VacationManager.Models.TeamModel", null)
                        .WithMany("Developers")
